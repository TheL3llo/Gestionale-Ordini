...
> `DATABASE_URL` è obbligatoria. Il database (es. `gestionale_ordini`) deve esistere già in PostgreSQL.
> Al primo avvio il backend crea automaticamente le tabelle (`orders`, `items`) nel database indicato.
